...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //String role = request.getParameter("role"); // From radio button
        
        // Validate user against the specific table based on role
        System.out.println("Passed successfully " + username + password + role);
        Volunteer volunteer = volunteerDAO.validateVolunteer(username, password, role);
        ...
        } else if ("admin".equals(username) && "pass123".equals(password) && "Admin".equals(role)) {
            HttpSession session = request.getSession();
